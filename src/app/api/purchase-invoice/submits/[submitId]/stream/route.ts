...
export async function GET(request: Request, { params }: { params: Promise<{ submitId: string }> }) {
  ...
  const upstreamUrl = `${baseUrl}/user/purchase-invoice/submits/${submitId}/stream`;
